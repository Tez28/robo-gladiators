// console log enemy
//console.log (enemy.name, enemy.attack, enemy.health);
// fight function
...
var fight = function (enemy) {
    ...
    while(playerInfo.health > 0 && enemy.health > 0) {
        if (isPlayerTurn){
            ...
            // remove enemey health by subtracting the amount set in the playerInfo.attack variable
...
var startGame = function() {
    ...
    for(var i = 0; i < enemyInfo.length; i++) {
        if (playerInfo.health > 0){
            ...
            // pick enemy to fight based on the index of the enemy.names array
